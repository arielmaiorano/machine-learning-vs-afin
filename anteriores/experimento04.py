...
def crear_modelo_nn():
	...
	return model
clasificadores.append(KerasClassifier(build_fn=crear_modelo_nn, epochs=250, batch_size=10, verbose=2))
...
def crear_modelo_rnn_lstm():
	...
	model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
	return model
clasificadores.append(KerasClassifier(build_fn=crear_modelo_rnn_lstm, epochs=250, batch_size=10, verbose=2))
