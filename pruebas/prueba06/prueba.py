...
def crear_modelo_nn():
	...
	return model
clasificadores.append(KerasClassifier(build_fn=crear_modelo_nn, epochs=100, batch_size=4096, verbose=2))
...
def crear_modelo_rnn_lstm():
	...
	model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
	return model
clasificadores.append(KerasClassifier(build_fn=crear_modelo_rnn_lstm, epochs=100, batch_size=4096, verbose=2))
